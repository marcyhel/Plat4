            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Linhas(tx1: "Estabelecimento", tx2: mob.some_y1.toStringAsFixed(1)),
                  Linhas(tx1: "Des. Vegetativo", tx2: mob.some_y2.toStringAsFixed(1)),
                  Linhas(tx1: "Florescimento", tx2: mob.some_y3.toStringAsFixed(1)),
                  Linhas(tx1: "Frutificação", tx2: mob.some_y4.toStringAsFixed(1)),
                  Linhas(tx1: "Maturação", tx2: mob.some_y5.toStringAsFixed(1)),
                ],
              ),
            ),
            Container(
              ...
              child: Column(
                children: [
                  Linhas(
                      tx1: 'Peso Seco',
                      tx2: mob.produtividade_potencial_peso.toStringAsFixed(1)),
                  Linhas(
                      tx1: 'Peso Úmido',
                      tx2: mob.produtividade_potencial_total.toStringAsFixed(1)),
                ],
              ),
            ),
            Container(
            ...
            Container(
              ...
              child: Column(
                children: [
                  Linhas(
                      tx1: 'Total de Dias',
                      tx2: mob.final_total_dias.toStringAsFixed(1)),
                  Linhas(
                      tx1: 'Quebra de produtividade',
                      tx2: (mob.final_quebra_produ.isNaN)
                          ? '0'
                          : mob.final_quebra_produ.toStringAsFixed(0)),
                  Linhas(
                      tx1: 'Produtividade Real',
                      tx2: mob.final_mat_prod.toStringAsFixed(1)),
                ],
              ),
            ),
          ],
